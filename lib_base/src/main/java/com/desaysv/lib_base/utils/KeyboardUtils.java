...
public final class KeyboardUtils {
    ...
    public static void showSoftInput() {
        InputMethodManager imm = (InputMethodManager) ApplicationUtils.INSTANCE.getApplication().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
    ...
    public static void showSoftInput(@NonNull final View view, final int flags) {
        InputMethodManager imm =
                (InputMethodManager) ApplicationUtils.INSTANCE.getApplication().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        if (delta <= ScreenUtils.getNavigationBarHeight(ApplicationUtils.INSTANCE.getApplication()) + ScreenUtils.getStatusBarHeight(ApplicationUtils.INSTANCE.getApplication())) {
